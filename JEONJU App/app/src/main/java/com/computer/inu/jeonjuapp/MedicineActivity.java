...
public class MedicineActivity extends AppCompatActivity {
    ...
    final private String[] TAP_TITLE={"약국"};
    ...
    private class TestPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int i) {
            switch(i){
                case 0:
                    return HospitalFragment.newInstance(new String[]{"약국"});
                default:
                    return null;
            }
        }
    ...
    private class LoadDataProgress extends AsyncTask<String, Void, Boolean>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(MedicineActivity.this);
        ...
        protected void onPostExecute(Boolean isSuccess) {
            pDialog.dismiss();
            if(!isSuccess) Toast.makeText(MedicineActivity.this,"데이터베이스 구성에 실패하였습니다.",Toast.LENGTH_SHORT).show();
            else{
                Intent intent=MedicineActivity.this.getIntent();
